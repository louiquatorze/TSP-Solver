...
VulkanCore::VulkanCore() {
    ...
    std::cout << "[C++] Vulkan Core successfully created.\n";  
}
...
VulkanCore::~VulkanCore() {
    ...
    std::cout << "[C++] Vulkan Core successfully destroyed.\n";    
}
...
i32 VulkanCore::ratePhysicalDevice(VkPhysicalDevice device) {
    VkPhysicalDeviceProperties deviceProperties;
...
std::optional<std::pair<u32, u32>> VulkanCore::findComputeQueueFamily(VkPhysicalDevice device) {
...
std::optional<u32> VulkanCore::findTransferQueueFamily(VkPhysicalDevice device) {
...
i32 VulkanCore::rateComputeQueueFamily(VkQueueFamilyProperties& properties) {
...
std::vector<VkDeviceQueueCreateInfo> VulkanCore::getQueueCreateInfos() {
